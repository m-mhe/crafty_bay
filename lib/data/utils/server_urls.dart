class ServerURLSs {
  ...
  static String addToWishList({required String productId}) =>
      '$_baseUrl/CreateWishList/$productId';
  static const String fetchWishList = '$_baseUrl/ProductWishList';

  static String deleteFromWishList({required String productId}) =>
      '$_baseUrl/RemoveWishList/$productId';
  static const String invoiceCall = '$_baseUrl/InvoiceCreate';
}
