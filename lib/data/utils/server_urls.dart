class ServerURLSs {
  ...
  static String productListByCategoryUrl(String id) => '$_baseUrl/ListProductByCategory/$id';
  static String productDetailsUrl(String id) => '$_baseUrl/ProductDetailsById/$id';
  static String logInUrl({required String email}) => '$_baseUrl/UserLogin/$email';
  static String authUrl({required String email, required String oTP}) => '$_baseUrl/VerifyLogin/$email/$oTP';
